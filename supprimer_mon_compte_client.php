<?php
	...
	$req="delete from COMPTE_CLIENT where ID_COMPTE_CLIENT = $id_compte_client ";
    $rs=mysqli_query($conn,$req) or die(mysqli_error());
	
	if(isset($_GET['conditon']) && isset($_GET['retour']))
	{
	    $conditon=htmlspecialchars(trim(addslashes($_GET['conditon'])));
